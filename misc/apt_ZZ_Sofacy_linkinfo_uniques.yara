rule apt_ZZ_Sofacy_linkinfo_uniques { 
    ...
    strings:
    	...
    	$a4 = "Active Acceessibility Resource File" fullword wide $a5 = "11.0.4621.4331splm.dll" fullword wide
    	$a6 = "13.5.6765.37769" fullword wide $a7 = "11.0.4621.4331" fullword wide $a8 = "5.1.2600.2185" fullword wide
